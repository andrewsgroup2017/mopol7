...
//    public static String WEBAPP_URL = "https://opol6-dev.firebaseapp.com/";
    public static String WEBAPP_URL = "http://192.168.1.6:9090/";
    public static String WEBAPP_HOST = "groupandrews.com"; // used for checking Intent-URLs
