...
import com.groupandrews.app.MainActivity;
import com.groupandrews.app.R;
...
public class LoggerService extends Service {
    ...
    public static final String BROADCAST_LOCATION_STARTED = "com.groupandrews.app.broadcast.location_started";
    public static final String BROADCAST_LOCATION_STOPPED = "com.groupandrews.app.broadcast.location_stopped";
    public static final String BROADCAST_LOCATION_UPDATED = "com.groupandrews.app.broadcast.location_updated";
    public static final String BROADCAST_LOCATION_PERMISSION_DENIED = "com.groupandrews.appbroadcast.location_permission_denied";
    public static final String BROADCAST_LOCATION_NETWORK_DISABLED = "com.groupandrews.app.broadcast.network_disabled";
    public static final String BROADCAST_LOCATION_GPS_DISABLED = "com.groupandrews.app.broadcast.gps_disabled";
    public static final String BROADCAST_LOCATION_NETWORK_ENABLED = "com.groupandrews.app.broadcast.network_enabled";
    public static final String BROADCAST_LOCATION_GPS_ENABLED = "com.groupandrews.app.broadcast.gps_enabled";
    public static final String BROADCAST_LOCATION_DISABLED = "com.groupandrews.app.broadcast.location_disabled";
...
//        final boolean prefsUpdated = (intent != null) && intent.getBooleanExtra(MainActivity.UPDATED_PREFS, false);
        final boolean prefsUpdated = false;
        if (prefsUpdated) {
            handlePrefsUpdated();
        } else if (isRunning) {
            // first start
    ...
    private void updatePreferences() {
        ...
        minTimeMillis = Long.parseLong(prefs.getString("prefMinTime", "10000"));
        minDistance = Float.parseFloat(prefs.getString("prefMinDistance", "0"));
        maxAccuracy = Integer.parseInt(prefs.getString("prefMinAccuracy", "100"));
        ...
        liveSync = prefs.getBoolean("prefLiveSync", true);
    }
    ...
    private Notification showNotification(int mId) {
        ...
        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this, channelId)
                        ...
                        .setContentTitle("Andrews")
                        .setContentText(String.format("AndrewsLogger is running", "AndrewsLogger"));
